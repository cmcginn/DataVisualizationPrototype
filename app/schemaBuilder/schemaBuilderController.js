 ...
 */
angular.module('myApp.schemaBuilder', ['ngRoute', 'myApp.dataservice'])
    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/schemaBuilder', {
            templateUrl: 'schemaBuilder/schemaBuilder.html',
            controller: 'SchemaBuilderController'
        });
    }]).controller('SchemaBuilderController', ['$scope', 'dataservice', function ($scope, dataservice) {
